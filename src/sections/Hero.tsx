      ...
      >
        ...
        >
          ...
          <a
            ...
            className="font-cta px-8 py-4 rounded-xl transition-all duration-300 inline-flex items-center gap-2"
            style={{
              border: '1px solid hsl(var(--border))',
              color: 'hsl(var(--muted-foreground))',
            }}
            onMouseEnter={e => {
              (e.target as HTMLElement).style.borderColor = 'hsl(var(--primary) / 0.5)';
